    ...
    if (!$access_granted) {
        ...
        if ($flag == "1") {
            $wp_admin_bar->add_menu(array
                ...
                "title" => "<img style=\"width:16px; height:16px; vertical-align:middle; margin-right:3px;\" src=" . plugins_url("assets/global/img/icons.png", dirname(__FILE__)) . "> " . $lab_limit_attempts,
            ...
            $wp_admin_bar->add_menu(array
                ...
                "href" => admin_url("admin.php?page=lab_feature_requests")
            ));
            ...
            $wp_admin_bar->add_menu(array
                (
                "parent" => "limit_attempts_booster",
                "id" => "error_logs_limit_attempts",
                "title" => $lab_error_logs,
                "href" => admin_url("admin.php?page=lab_error_logs")
            ));

            $wp_admin_bar->add_menu(array
                (
                "parent" => "limit_attempts_booster",
                "id" => "upgrade_limit_attempts",
                "title" => $lab_upgrade,
                "href" => admin_url("admin.php?page=lab_upgrade")
            ));
        }
    }
}