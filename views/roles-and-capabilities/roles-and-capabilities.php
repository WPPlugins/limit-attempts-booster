...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        return;
    } else if (roles_and_capabilities_limit_attempts_booster == "1") {
        ...
        <?php echo $lab_roles_capabilities_show_menu; ?> :
                                        <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_show_menu_tooltip; ?>" data-placement="right"></i>
                                        <span class="required" aria-required="true">* <?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                    </label>
                                    <table class="table table-striped table-bordered table-margin-top" id="ux_tbl_limit_attempts_roles">
                                        <thead>
                                            <tr>
                                                <th>
        ...
        <?php echo $lab_roles_capabilities_administrator; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_author" id="ux_chk_author"  value="1" onclick="show_roles_capabilities_limit_attempts_booster(this, 'ux_div_author_roles');" <?php echo $roles_and_capabilities[1] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_author; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_editor" id="ux_chk_editor" value="1" onclick="show_roles_capabilities_limit_attempts_booster(this, 'ux_div_editor_roles');" <?php echo $roles_and_capabilities[2] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_editor; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_contributor" id="ux_chk_contributor"  value="1" onclick="show_roles_capabilities_limit_attempts_booster(this, 'ux_div_contributor_roles');" <?php echo $roles_and_capabilities[3] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_contributor; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_subscriber" id="ux_chk_subscriber" value="1" onclick="show_roles_capabilities_limit_attempts_booster(this, 'ux_div_subscriber_roles');" <?php echo $roles_and_capabilities[4] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_subscriber; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_other" id="ux_chk_other" value="1" onclick="show_roles_capabilities_limit_attempts_booster(this, 'ux_div_other_roles');" <?php echo $roles_and_capabilities[5] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_others; ?>
                                                </th>
                                            </tr>
                                        </thead>
                                    </table>
                                ...
                                <div class="form-group">
                                    <label class="control-label">
        <?php echo $lab_roles_capabilities_topbar_menu; ?> :
                                        <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_topbar_menu_tooltip; ?>" data-placement="right"></i>
                                        <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_administrator_roles">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_administrator_role; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_administrator_role_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
        ...
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
        ...
        <?php echo $lab_error_logs; ?>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_author_roles">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_author_role; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_author_role_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_author">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_author" id="ux_chk_full_control_author" value="1"  onclick="full_control_function_limit_attempts_booster(this, 'ux_div_author_roles');"  <?php echo isset($author) && $author[0] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_dashboard_author" id="ux_chk_dashboard_author" value="1" <?php echo isset($author) && $author[1] == "1" ? "checked = checked" : "" ?>?>
        <?php echo $lab_dashboard; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_roles_and_capability; ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_cron_jobs_author" id="ux_chk_cron_jobs_author" value="1" <?php echo isset($author) && $author[7] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $lab_cron_jobs; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_error_logs; ?>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_editor_roles">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_editor_role; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_editor_role_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_editor">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_editor" id="ux_chk_full_control_editor" value="1" onclick="full_control_function_limit_attempts_booster(this, 'ux_div_editor_roles');" <?php echo isset($editor) && $editor[0] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_dashboard_editor" id="ux_chk_dashboard_editor" value="1" <?php echo isset($editor) && $editor[1] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_dashboard; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_roles_and_capability; ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_cron_jobs_editor" id="ux_chk_cron_jobs_editor" value="1" <?php echo isset($editor) && $editor[7] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $lab_cron_jobs; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_error_logs; ?>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_contributor_roles">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_contributor_role; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_contributor_role_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_contributor">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_contributor" id="ux_chk_full_control_contributor" value="1" onclick="full_control_function_limit_attempts_booster(this, 'ux_div_contributor_roles');" <?php echo isset($contributor) && $contributor[0] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_dashboard_contributor" id="ux_chk_dashboard_contributor" value="1" <?php echo isset($contributor) && $contributor[1] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_dashboard; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_roles_and_capability; ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_cron_jobs_contributor" id="ux_chk_cron_jobs_contributor" value="1" <?php echo isset($contributor) && $contributor[7] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $lab_cron_jobs; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_error_logs; ?>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_subscriber_roles">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_subscriber_role; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_subscriber_role_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_subscriber">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_subscriber" id="ux_chk_full_control_subscriber" value="1" onclick="full_control_function_limit_attempts_booster(this, 'ux_div_subscriber_roles');" <?php echo isset($subscriber) && $subscriber[0] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_dashboard_subscriber" id="ux_chk_dashboard_subscriber" value="1" <?php echo isset($subscriber) && $subscriber[1] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_dashboard; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_roles_and_capability; ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_cron_jobs_subscriber" id="ux_chk_cron_jobs_subscriber" value="1" <?php echo isset($subscriber) && $subscriber[7] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $lab_cron_jobs; ?>
                                                        </td>
                                                        <td>
        ...
        <?php echo $lab_error_logs; ?>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_other_roles">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_other_role; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_other_role_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_other">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_other" id="ux_chk_full_control_other" value="1" onclick="full_control_function_limit_attempts_booster(this, 'ux_div_other_roles');" <?php echo isset($other) && $other[0] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_dashboard_other" id="ux_chk_dashboard_other" value="1" <?php echo isset($other) && $other[1] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_dashboard; ?>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_logs_other" id="ux_chk_logs_other" value="1" <?php echo isset($other) && $other[2] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_logs; ?>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_advance_security_other" id="ux_chk_advance_security_other" value="1" <?php echo isset($other) && $other[3] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_advance_security; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_general_settings_other" id="ux_chk_general_settings_other" value="1" <?php echo isset($other) && $other[4] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $lab_general_settings; ?>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_templates_other" id="ux_chk_templates_other" value="1" <?php echo isset($other) && $other[5] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_email_templates_menu; ?>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_roles_other" id="ux_chk_roles_other" value="1" <?php echo isset($other) && $other[6] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_and_capability; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_cron_jobs_other" id="ux_chk_cron_jobs_other" value="1" <?php echo isset($other) && $other[7] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $lab_cron_jobs; ?>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_system_information_other" id="ux_chk_system_information_other" value="1" <?php echo isset($other) && $other[8] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_system_information; ?>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_error_logs_other"  id="ux_chk_error_logs_other" value="1" <?php echo isset($other) && $other[9] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_error_logs; ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div class="form-group">
                                    <div id="ux_div_other_roles_capabilities">
                                        <label class="control-label">
        <?php echo $lab_roles_capabilities_other_roles_capabilities; ?> :
                                            <i class="icon-custom-question tooltips" data-original-title="<?php echo $lab_roles_capabilities_other_roles_capabilities_tooltip; ?>" data-placement="right"></i>
                                            <span class="required" aria-required="true">*<?php echo " ( " . $lab_premium_editions_label . " )" ?></span>
                                        </label>
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_other_roles">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_other_roles" id="ux_chk_full_control_other_roles" value="1" onclick="full_control_function_limit_attempts_booster(this, 'ux_div_other_roles_capabilities');" <?php echo $details_roles_capabilities["others_full_control_capability"] == "1" ? "checked = checked" : "" ?>>
        <?php echo $lab_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
