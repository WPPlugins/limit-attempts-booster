...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        return;
    } else if (system_information_limit_attempts_booster == "1") {
        ?>
        <div class="page-bar">
        ...
        echo $wpdb->db_version(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
        <?php if (defined("WP_DEBUG") && WP_DEBUG) echo "Yes";
        else echo "No"; ?>
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
        <?php if (defined("WPLANG") && WPLANG) echo WPLANG;
        else echo get_locale(); ?>
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
