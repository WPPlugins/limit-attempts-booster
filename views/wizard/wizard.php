                                ...
                                <div class="page-content">
                                    ...
                                    <div class="row row-custom">
                                        <div class="col-md-12 textalign">
                                            ...
                                            <p><strong>Limit Attempts Booster will still work fine.</strong></p>
                                        </div>
                                    </div>
                                    <div class="row row-custom">
                                        <div class="col-md-12">
                                            <a class="permissions" onclick="show_hide_details_limit_attempts();">What permissions are being granted?</a>
                                        </div>
