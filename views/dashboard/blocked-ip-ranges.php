                                        ...
                                        foreach ($manage_ip_ranges as $row) {
                                            ...
                                            <tr>
                                                <td style="text-align: center; width: 5%;">
                                                    <input type="checkbox" onclick="check_all_limit_attempts_booster('#ux_chk_all_manage_ip_ranges');" name="ux_chk_manage_ip_ranges_<?php echo intval($row["meta_id"]); ?>" id="ux_chk_details_<?php echo intval($row["meta_id"]); ?>" value="<?php echo intval($row["meta_id"]); ?>">
                                                </td>
                                                <td>
                                                    <label>
                                                ...
                                                <td class="custom-alternative" style="width: 10%;">
                                                    <a href="javascript:void(0);">
                                                        <i class="icon-custom-trash tooltips" data-original-title="<?php echo $lab_delete; ?>" onclick="delete_ip_ranges_last_logins(<?php echo intval($row["meta_id"]); ?>)" data-placement="right"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php
