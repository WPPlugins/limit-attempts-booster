...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        ...
        <?php echo $lab_login_logs_on_world_map; ?>
                        </div>
                    </div>
        ...
        <?php echo $lab_action; ?>
                                        ...
                                        <tbody id="dynamic_table_filter">
                                                ...
                                                <tr>
                                                    <td style="text-align:center;">
                                                        <label>
                                                            <input  type="checkbox" onclick="check_all_limit_attempts_booster('#ux_chk_all_user');" name="ux_chk_last_login_<?php echo intval($row["meta_id"]) ?>" id="ux_chk_last_login_<?php echo intval($row["meta_id"]) ?>" value="<?php echo intval($row["meta_id"]); ?>">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
            ...
            <?php echo esc_attr($row["status"]); ?>
                                                    ...
                                                    <td class="custom-alternative"  style="width: 10%;">
                                                        <a href="javascript:void(0);" class="icon-custom-trash tooltips" data-original-title="<?php echo $lab_delete; ?>" onclick="delete_data_logs(<?php echo intval($row["meta_id"]); ?>);" data-placement="top"></a>
